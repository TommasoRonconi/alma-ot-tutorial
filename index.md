...
1. [Introduction](docs/01_introduction.md) — Why we are here and what has changed
2. [Before you start](docs/02_before_you_start.md) — What you need before opening the OT
3. [Navigating the Web OT](docs/03_navigating_the_web_ot.md) — Interface overview
